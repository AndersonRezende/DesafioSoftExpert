    ...
    <section class="py-5 text-center container">
        <div class="row py-lg-5">
            <div class="col-lg-12 col-md-8 mx-auto">
                <h1 class="fw-light mb-5">Cadastro de Imposto</h1>
            </div>
            ...
            <div class="my-5">
                <form action="/tax/store" method="post">
                    ...
                    <div class="row justify-content-center mb-4">
                        <div class="col-6">
                            <div class="form-outline form-white mb-4">
                                ...
                                <input name="value" type="text" id="valueInput" class="form-control form-control-lg" step="0.01" min="0" max="10" required/>
                            </div>
                        </div>
                    </div>
